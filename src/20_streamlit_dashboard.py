...
<style>
    ...
    .panel {
        ...
        box-shadow: 0 9px 28px rgba(21, 48, 75, 0.065);
...
if navigation == "Executive Overview":
    ...
    with metric_columns[1]:
        render_metric_card(
            ...
            "Records prioritised for inspection.",
        )
    ...
    with metric_columns[3]:
        render_metric_card(
            ...
            "Records for which the system abstained.",
        )
    ...
    with metric_columns[4]:
        render_metric_card(
            ...
            "Average calibrated probability across reports.",
        )
    ...
    with lower_right:
        ...
        render_panel_header(
            ...
            "Highest-ranked actionable records using the retained decision, probability and uncertainty.",
        )
